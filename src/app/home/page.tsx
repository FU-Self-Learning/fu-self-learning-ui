      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute top-10 left-14 text-white flex flex-col items-start gap-4 max-w-xl">
          ...
          <p className="text-white text-xl leading-relaxed">
            Search millions of study sets or create your own. Improve your
            grades and productivity with studying tools like flashcards, notes,
            note-taking templates, practice tests, and study planners.
          </p>
