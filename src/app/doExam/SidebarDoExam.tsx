    ...
    return (
        <div className="w-80 flex flex-col justify-between bg-white p-6 shadow-lg">
            <div>
                <div className="mb-8">
                    <Statistic.Timer
                        title={<Text strong className="text-lg">Time Remaining</Text>}
                ...
                <div className="mb-8">
                    <Text strong className="text-lg block mb-2">Progress</Text>
                    <Progress
                ...
                <div className="mb-6">
                    <Text strong className="text-lg block mb-4">Question Navigation</Text>
                ...
                <div className="mb-6">
                    <Text strong className="text-lg block mb-2">Legend</Text>
