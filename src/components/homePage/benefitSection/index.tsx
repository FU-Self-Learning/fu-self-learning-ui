...
const benefitMore = [
  {
    ...
    description: 'Organize and manage teams, projects, and folders visually and effectively.',
    animate: {
      translateX: [-200, 0, 0],
      translateY: [-200, 0, 0],
    },
  ...
  },
  {
    ...
    description: 'Connect and use powerful tools to boost your productivity.',
    animate: {
      translateX: [0, 0, 0],
      translateY: [-200, 0, 0],
    },
  ...
  },
  {
    ...
    description: 'Collaborate and share ideas with teammates in real time without interruptions.',
    animate: {
      translateX: [200, 0, 0],
      translateY: [-200, 0, 0],
    },
  ...
  },
  {
    ...
    description: 'Keep your data safe with world-class security standards.',
    animate: {
      translateX: [-200, 0, 0],
      translateY: [200, 0, 0],
    },
  ...
  },
  {
    ...
    description: 'Access and work from any device, from desktop to mobile.',
    animate: {
      translateX: [0, 0, 0],
      translateY: [200, 0, 0],
    },
    ...
    <>
      <div className='flex flex-col items-center bg-[#F5F3EA] w-full h-auto font-bold overflow-hidden'>
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <motion.span
                    ...
                    viewport={{ once: true }}
                  >
                    <Image src={benefit.image} alt={benefit.title} width={80} height={80} />
                  </motion.span>
        ...
        <div className='bg-[#F5F3EA]'>
          <Section title='And so much more' subTitle='Use it effectively to make a difference.'>
