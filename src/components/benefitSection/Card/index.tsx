        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col gap-1 sm:flex-col sm:gap-2 md:flex-col md:gap-2 lg:flex-col lg:gap-2">
                    <h3 className="font-bold  text-left text-black text-sm  group-hover:text-white sm:text-center md:text-center md:text-sm lg:text-center lg:text-base">
                        {data?.title}
                    </h3>
                    <p className="text-left font-medium text-black text-xs group-hover:text-white sm:text-center md:text-center md:text-sm lg:text-center lg:text-base">
                        {data?.description}
                    </p>
                </div>
            </motion.button>
