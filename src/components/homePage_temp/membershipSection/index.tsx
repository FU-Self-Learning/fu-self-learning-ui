...
const data = [
  {
    id: 1,
    title: 'Free',
    description: 'Perfect for trying out basic features or starting with group study.',
    price: 0,
    features: ['Create up to 3 study groups', 'Basic course access', 'Community forum support'],
    labelColor: 'yellow',
    animate: {
      x: -20,
      y: 0,
  ...
  },
  {
    id: 2,
    title: 'Advanced',
    description: 'Ideal for expanding study groups and using advanced features.',
    price: 100000,
    features: [
  ...
  },
  {
    id: 3,
    title: 'Professional',
    description: 'Designed for intensive study groups with higher learning needs.',
    price: 500000,
    features: [
...
export default function MembershipSection() {
  ...
  return (
    <div className='flex justify-center items-center h-[800px] mt-5 mb-12'>
      <Section
