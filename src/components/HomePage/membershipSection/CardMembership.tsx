...
function CardMemberShip({ data, ref, hidden }: CardProps) {
  ...
  const translateY = useTransform(scrollYProgress, [1, 0.005, 0.5], [1, 0, 0]);
  ...
  return (
    ...
    >
      <div className={cardClass}>
        ...
        <Button className='mb-6 w-full !py-5 !text-xl sm:mb-8 sm:py-4 sm:text-base md:mb-10 md:py-5 md:text-xl lg:mb-12 lg:py-6 lg:text-xl !border-r-[4px] !border-b-[4px] !border-[2px] !border-solid !border-black !font-bold !bg-blue-500'>
          Start
        </Button>
