...
const items: CollapseProps['items'] = [
  {
    ...
    children: (
      <p className='pl-6 text-gray-700 leading-relaxed'>
        Simply go to the &quot;Study Bank&quot;, select &quot;Create Flashcard&quot;, and fill in
        the required information. You can then save and share it with your friends.
      </p>
    ),
  },
  {
    ...
    children: (
      <p className='pl-6 text-gray-700 leading-relaxed'>
        With an advanced account, you can download study materials and access them without an
        internet connection.
      </p>
    ),
  },
  {
    ...
    children: (
      <p className='pl-6 text-gray-700 leading-relaxed'>
        Go to the &quot;Group Challenge&quot; section, create a study room, and invite your friends
        via a link. The scoreboard will update in real time.
      </p>
    ),
  },
  {
    ...
    children: (
      <p className='pl-6 text-gray-700 leading-relaxed'>
        Click on &quot;Account&quot; in the top right corner, select &quot;Upgrade&quot;, and follow
        the instructions to complete the payment.
      </p>
    ),
  },
  {
    ...
    children: (
      <p className='pl-6 text-gray-700 leading-relaxed'>
        Yes. We are committed to protecting your information using encryption methods and by
...
export default function PopularQuestion() {
  ...
  return (
    <div className='w-full bg-[#4682B4] mt-[100px]'>
      ...
      >
        <motion.div className='text-[50px] font-bold text-center mb-6 text-black'>
      ...
      <OceanWave color='#4682B4' flipY={false} />
    </div>
  );
}
