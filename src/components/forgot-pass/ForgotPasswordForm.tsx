...
export const ForgotPasswordForm = ({ form, handleSubmit, isPending }: ForgotPasswordFormProps) => {
  return (
    <Form form={form} layout='vertical' onFinish={handleSubmit}>
      ...
      >
        <Input size='large' className='!px-6 !py-3 !rounded-lg' placeholder='Enter your email' />
      </Form.Item>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='text-center'>
          <Link href='/login' className='font-medium text-[#4178a7] hover:text-[#4178a7]/80'>
            Back to Login
          </Link>
        </div>
      </div>
