            ...
            {fileList.map((file) => (
              <div
                ...
                className={`relative cursor-pointer border rounded p-1 ${
                  selectedFileUid === file.uid ? 'border-blue-500' : 'border-gray-300'
                }`}
                ...
                {filters.map((filter) => (
                  <div
                    ...
                    className={`cursor-pointer border rounded overflow-hidden ${
                      filterStyle === filter.style ? 'border-blue-500' : 'border-gray-300'
                    }`}
                  ...
                  >
                    <Image
                      src={URL.createObjectURL(
                        fileList.find((f) => f.uid === selectedFileUid)!.originFileObj,
                      )}
                      alt={filter.name}
                      preview={false}
                      style={{
