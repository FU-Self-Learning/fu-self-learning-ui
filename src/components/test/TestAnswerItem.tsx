import { Card, Tag, Typography, List, Button } from 'antd';
import { ClockCircleOutlined, FileTextOutlined, RobotOutlined } from '@ant-design/icons';
          ...
          <div className='space-y-4'>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <Text
                  strong
                  className={`text-lg ${isWrongAnswer ? 'text-red-700' : 'text-green-700'}`}
                >
                  {answer.questionText}
                </Text>
              </div>
